...
- 2026-08-01: A pinned pi CLI is the repository-aware investigator lane. It runs DeepSeek V4 Flash in an isolated, no-session JSONL process with read/search/list tools only; reports remain task-scoped, self-hashed, unreviewed proposals with no execution authority.
